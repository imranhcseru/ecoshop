...
@section('homeContent')
    ...
    <div class="container" align = "center">
        <div class = "row"> 
            <div class = "row">
                <span class = "row-title" style="background-color:khaki;width:100%;">
                <h3 >Flash Sale</h3>
                </span>
                <span class = "row-title" style = "margin-left:1150px; margin-top:13px;">
                    <a href = "flashsale" class = "btn btn-info">Show More</a>
                </span>
            </div>
        ...
        <br>
        <div class = "row"> 
            <div class = "row" style="background-color:khaki;width:100%;">
        ...
        <div class = "row" style="margin-left:100px;"> 
            ...
            <div class = "row" align = "center" id = "prod4u">
                <div v-for = "(product,index) in allProducts" v-if="index <= 29">
                        <div class="card"  style="width: 22rem;">
